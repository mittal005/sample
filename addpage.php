...
if(isset($_POST['saveDraft']))
{
 ...
 $query="INSERT INTO pages(username,user_id,Title,Content,Status,Visibility,draftTime,selectCategory,categoryName,categoryType,seo_title,description, url,seo_schema,image, onlyDate)VALUES('$username','$user_id','$addTitle','$postContent','$statusdropdown','$visible','$current_time','$selectCategory','$category_name','$category_type','$seo_title','$description','$url','$schema','$post_image','$current_time')";
...
if ($statusdropdown == 'Publish') {
 $query="INSERT INTO pages(username,user_id,Title,Content,Status,Visibility,publishTime,selectCategory,categoryName,categoryType,seo_title,description, url,seo_schema,image, onlyDate)VALUES('$username','$user_id','$addTitle','$postContent','$statusdropdown','$visible','$current_time','$selectCategory','$category_name','$category_type','$seo_title','$description','$url','$schema','$post_image','$current_time')";
  $create_post_query=mysqli_query($connection,$query);
  if (!$create_post_query) {
