...
// -------------------------------------------------------------------
 $username_login="SELECT username FROM login WHERE username='{$username}'";
     $select_username_login=mysqli_query($connection,$username_login);
  if (!$select_username_login) {
    printf("Error: %s\n", mysqli_error($connection));
    exit();
  }
  if($select_username_login){
     $row_admin = mysqli_num_rows($select_username_login); 
     //echo $row;
     } 
