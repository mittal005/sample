...
if (isset($_POST['upload_photo'])) {
   ...
   //  <img src="gallery/'.$post_image.'" width="100%" height="40%">
   //  </div>';

  //  $query="UPDATE posts SET image='$post_image' WHERE id={$edit_image}";
  // $updated_query=mysqli_query($connection,$query);
  //  if (!$updated_query) {
  //   printf("Error: %s\n", mysqli_error($connection));
  //   exit();
  // }        
   echo $image=$_POST['post_image'];
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="img-container">
         ...
         <!--  <img src="img/gallery/imgbox1.jpg" alt="Picture" name="post_image"> -->
         <!-- <input type="text" name="" value='<?php //echo gallery/'.$image.'   ?>'> -->
 echo '
    <img src="gallery/'.$image.'" name="post_image">
    ';
      ...
      <div class="col-md-9 docs-buttons">
        ...
        <div class="btn-group">
          ...
          <label class="btn btn-primary btn-upload" for="inputImage" title="Upload image file">
            ...
            <!-- <input type="file" class="sr-only" id="inputImage" name="post_image" accept="image/*"> -->
